...
6. API Test for Perl
7. Change default for all implementation to generate Uncode and not \u.... sequences
8. Allow Perl code to take key=>value, or options hash ref for variable argument list.
