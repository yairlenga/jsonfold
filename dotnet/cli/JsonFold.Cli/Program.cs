...
static JsonFoldConfig? BuildConfig(CliOptions options)
{
    ...
    return config with
    {
        PackArrayItems = options.PackArrayItems ?? config.PackArrayItems,
        PackObjItems = options.PackObjItems ?? config.PackObjItems,
        PackNesting = options.PackNesting ?? config.PackNesting,

        FoldArrayItems = options.FoldArrayItems ?? config.FoldArrayItems,
        FoldObjItems = options.FoldObjItems ?? config.FoldObjItems,
        FoldNesting = options.FoldNesting ?? config.FoldNesting,

        GridArrayItems = options.GridArrayItems ?? config.GridArrayItems,
        GridObjItems = options.GridObjItems ?? config.GridObjItems,
        ...
        JoinArrayItems = options.JoinArrayItems ?? config.JoinArrayItems,
        JoinObjItems = options.JoinObjItems ?? config.JoinObjItems,
